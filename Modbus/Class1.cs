...
namespace Modbus
{
    public class ModbusClient
    {
        ...
        {
            if (debug) StoreLogData.Instance.Store("SiemensLOGO library initialized for Modbus-TCP, IPAddress: " + ipAddress + ", Port: " + port, System.DateTime.Now);
        ...
        {
            if (debug) StoreLogData.Instance.Store("SiemensLOGO library initialized for Modbus-RTU, COM-Port: " + serialPort, System.DateTime.Now);
        ...
        public ModbusClient()
        {
            if (debug) StoreLogData.Instance.Store("SiemensLOGO library initialized for Modbus-TCP", System.DateTime.Now);
        }
        ...
        /// <summary>
        /// Converts two ModbusRegisters to Float - Example: SiemensLOGO.ModbusClient.ConvertRegistersToFloat(modbusClient.ReadHoldingRegisters(19,2))
        /// </summary>
        ...
        /// <summary>
        /// Converts float to two ModbusRegisters - Example:  modbusClient.WriteMultipleRegisters(24, SiemensLOGO.ModbusClient.ConvertFloatToTwoRegisters((float)1.22));
        /// </summary>
